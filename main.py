...
def test(model, data_loader, device):
    ...
    #convert targets float list to a binary list
    targets = [round(x) for x in targets]
    predicts = [round(x) for x in predicts]

    # Return AUC score between predicted ratings and actual ratings
    #return roc_auc_score(targets, predicts)
    # Return F1 score between predicted ratings and actual ratings
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='ml-25m/ratings.csv')
